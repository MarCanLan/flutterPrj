          ...
          children: [
            ...
            Obx(
              (() => Get.find<SearchController1>().isLoading.value
                  ...
                  : Get.find<SearchController1>().foundedP.isEmpty
                      ? SizedBox(
                          width: Get.width / 1.5,
                          child: Column(
                            children: [
                              ...
                              const Opacity(
                                opacity: .8,
                                child: Text(
                                  'Find your actor by his/her name ',
                                  textAlign: TextAlign.center,
                                  style: TextStyle(
                                    fontSize: 16,
                      ...
                      : ListView.separated(
                          itemCount:
                              Get.find<SearchController1>().foundedP.length,
                          shrinkWrap: true,
                          ...
                          itemBuilder: (_, index) {
                            Person p =
                                Get.find<SearchController1>().foundedP[index];
                            return GestureDetector(
                              onTap: () => Get.to(DetailsScreenPerson(p: p)),
                              child: Row(
